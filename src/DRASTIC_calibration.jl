...
"""
function get_calibration_factor_gpt(calib_img::AbstractArray{RGB{N0f8}}, red_calib_color::HSV{<:AbstractFloat}, threshold::T=0.15, d_red_circles::T=10.0) where {T<: AbstractFloat}
